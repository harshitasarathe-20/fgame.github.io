...
function right() {
    swal({
        title: "Good Job!",
        text: "Potassium chloride (KCl) is a water-soluble compound that is generally used to prevent  severe potassium loss (Hypokalemia) or severe potassium loss of various etiologies whereas Magnesium(Mg) aids in the production of energy and protein.",
        icon: "correct.jpg",
        button: "OK",
    });
}
