...
function right() {
    swal({
        title: "Good Job!",
        text: "Magnesium Chloride(MgCl2) is an inorganic salt which is crystalline and hygroscopic. It is used in fire extinguishers, in ceramics and in production of fireproofing wood whereas Aluminium(Al) is a good electrical conductor and is often used in electrical transmission lines.",
        icon: "correct.jpg",
        button: "OK",
    });
}
